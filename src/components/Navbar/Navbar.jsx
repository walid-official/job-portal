...
const Navbar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#0f70c2] to-[#0f70c2] py-4">
      <div className="w-[82%] mx-auto">
        <div className="navbar">
          ...
          <div className="navbar-end space-x-4">
            ...
            <button className="btn bg-[#0f70c2] hover:bg-[#0f70c2] text-white">Login</button>
            <button className="btn bg-[#0f70c2] hover:bg-[#0f70c2] text-white">Register</button>
          </div>
        </div>
      </div>
    </div>
