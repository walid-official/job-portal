  ...
  return (
    <div className="group">
      <div className="card bg-base-100 text-[#090505] duration-700 relative shadow-xl overflow-hidden">
        {/* Hover overlay */}
        <div className="absolute top-0 left-0 inset-0 bg-gradient-to-r from-[#55a1ff] to-[#0f70c2] opacity-0 group-hover:opacity-50 transition-opacity duration-700 rounded-xl"></div>
        {/* Card content */}
